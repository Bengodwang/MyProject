package com.example.bengodwang.mybmi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected TextView standardWeight,bodyFat;
    ...
    private void runAsyncTask() {
        ...
        new AsyncTask<Void, Integer,Boolean>(){
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                double cal_SrandWeight=0;
                double cal_BodyFat=0;
                if(gender==1){
                    cal_SrandWeight=22*cal_Tall/100*cal_Tall/100;
                    cal_BodyFat=(cal_Weight-(0.88*cal_SrandWeight))/cal_Weight*100;
                }
                if(gender==2){
                    cal_SrandWeight= 22*cal_Tall/100*cal_Tall/100;
                    cal_BodyFat=(cal_Weight-(0.82*cal_SrandWeight))/cal_Weight*100;
                }
                standardWeight.setText(String.format("%.2f",cal_SrandWeight));
